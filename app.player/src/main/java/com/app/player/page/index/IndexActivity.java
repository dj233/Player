package com.app.player.page.index;
...
import com.app.player.page.index.adapter.ViewPagerAdapter;
...
public class IndexActivity extends AppCompatActivity {
    ...
    private void loadBlurAndSetStatusBar() {
        StatusBarUtil.setTranslucent(IndexActivity.this, StatusBarUtil.DEFAULT_STATUS_BAR_ALPHA);
